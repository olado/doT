...
var doT = {
	...
	template: function(tmpl, c, def){
		...
		var resolveDefs = function(c, block, def){ if(block !=null){
			...
			startend = {
				append: { start: "'+(",      end: ")+'",      encode: "'+encodeHTML(" }
				,split:  { start: "';out+=(", end: ");out+='", encode: ";out+=encodeHTML("}
			},
		...
		str = ("var out='" + (c.strip ? str.replace(/(^|\r|\n)\t* +| +\t*(\r|\n|$)/g,' ')
				...
				.replace(c.valEncode || skip, function(m, op, code){ // =|! expr -- interpolate or encode
					return (needhtmlencode = op =='!'? cse.encode : cse.start) + unescape(code) + cse.end;
				})
		...
		try{
			return new Function(c.varname, str = (needhtmlencode ?'var encodeHTML=(function(encRules, r){return function(a){return a.replace(r, function(m){return encRules[m]})} })({"&":"&#38;", "<":"&#60;", ">":"&#62;", "\\"":"&#34;", "\'": "&#39;", "/":"&#47;"}, /&(?!#?\\w+;)|[<>"\'/]/g);':'')+ str );
		}catch(er){
...
if(typeof module !=='undefined'&& module.exports)
	...
	global.doT = doT; /* jshint ignore:end */
}
